...
public class Optimizer4Game {
	...
	public static void main(String[] args) throws IOException, BiffException,
		...
		// Input Area Starts
		WritableWorkbook lineup = Workbook.createWorkbook(new File ("10-27 3-game top.xls"));
		...
		shh.addCell(new Label(12,0,"Game 1"));
		shh.addCell(new Label(13,0,"Game 2"));
		shh.addCell(new Label(14,0,"Game 3"));
		shh.addCell(new Label(15,0,"Game 4"));
		shh.addCell(new Label(16,0,"Same Team"));
		shh.addCell(new Label(17,0,"Start"));
		shh.addCell(new Label(18,0,"Score"));
								...
								for (int pf1 = 0; pf1 < pf.size() - 1; pf1++)
									for (int pf2 = pf1 + 1; pf2 < pf.size(); pf2++)
										for (int c1 = 0; c1 < c.size(); c1++) {
											...
											if (salarySum>=58000 && salarySum<=60000 && scoreSum >=312 && otherConditions == true) {
												for (Player ele : roster) {
												...
												shh.addCell(new Label(++column, row, Integer.toString(game1)));
												shh.addCell(new Label(++column, row, Integer.toString(game2)));
												shh.addCell(new Label(++column, row, Integer.toString(game3)));
												shh.addCell(new Label(++column, row, Integer.toString(game4)));
												shh.addCell(new Label(++column, row, Integer.toString(maxSameTeam)));
